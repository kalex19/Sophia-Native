  ...
  handleCaretakerSubmit = async () => {
    ...
    if (
      ...
      const user = await logInUser(
        newCaretaker.username,
        newCaretaker.password
      );
      this.props.logIn(user);
  ...
  renderClientInformationForm = () => {
    return (
      <ScrollView style={{ flex: 1, width: "100%" }}>
        ...
        <Button
          accessibilityLabel="Tap me to go back"
    ...
    return (
      <ScrollView style={{ flex: 1, width: "100%" }}>
        <Text style={styles.text}>
          Separate multiple input values by commas
        </Text>
        <Input
  ...
  renderCaretakerForm = () => {
    return (
      <ScrollView style={{ flex: 1, width: "100%" }}>
        <Text
          style={styles.text}
          accessibilityLabel="Separate multiple input values with commas"
        >
  ...
  render() {
    ...
    return (
      <KeyboardAvoidingView
        ...
        accessible
      >
        <Header accessibilityLabel="Fill in the inputs to create an account">
          Create Account
        </Header>
        {formToRender}
